const A = [
  ...
  88335010, 97188304, 108865098, 124235134, 139022022, 153141713, 172811822, 190890054,
  200312795, 216014469, 237070344, 253638253, 283156154, 305326650, 355174198, 378180071,
  409582632, 452223522, 475275644, 506667054, 526213934, 539896788, 563821400, 585270478,
  601099674, 654435948, 758804471, 804685868, 890422132, 971808152, 1000000000
];
...
const B = [
  ...
  5996301, 6117425, 6263291, 6366558, 6529346, 6636384, 6838469, 6916726,
  7010824, 7118453, 7168292, 7227955, 7260780, 7281943, 7315613, 7342448,
  7360370, 7410236, 7469885, 7484060, 7497193, 7499952, 7500000
];
...
function calculatescore() {
  ...
  const decrease = Number(document.getElementById("decreasescore").value) || 0;
  let total = 0;
  ...
  document.getElementById("outputscore").innerText = `合計スコア：${total.toLocaleString()}`;
}
